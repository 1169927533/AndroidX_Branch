package com.example.androidx_branch.nestedscroll.method2;
...
public class NestedChildView extends View implements NestedScrollingChild {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                int dy = (int) (y - mDownY);
                int dx = (int) (x - mDownX);
                Log.d(TAG, "onTouchEvent: 子类让父类走的距离：" + dy);
                //分发触屏事件给父类处理
    ...
    public boolean dispatchNestedScroll(int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int[] offsetInWindow) {
        boolean parentHasMov = mScrollingChildHelper.dispatchNestedScroll(dxConsumed, dyConsumed, dxUnconsumed, dyUnconsumed, offsetInWindow);
        Log.d(TAG, "dispatchNestedScroll: " + parentHasMov);
        return parentHasMov;
    }
    ...
    public boolean dispatchNestedPreScroll(int dx, int dy, int[] consumed, int[] offsetInWindow) {
        boolean run = mScrollingChildHelper.dispatchNestedPreScroll(dx, dy, consumed, offsetInWindow);
        Log.d(TAG, "dispatchNestedPreScroll: " + run);
        return run;
    }
